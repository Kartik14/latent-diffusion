...
class ImageNetTrain(ImageNetBase):
    ...
    def __init__(
        self, process_images=True, data_root="/usr1/vishwaja/pgm/datasets", **kwargs
    ):
...
class ImageNetSR(Dataset):
    def __init__(
        ...
        self.out_image_rescaler = albumentations.SmallestMaxSize(
            max_size=self.out_size, interpolation=cv2.INTER_AREA
        )
    ...
    def __getitem__(self, i):
        ...
        out_image = self.out_image_rescaler(image=image)["image"]
